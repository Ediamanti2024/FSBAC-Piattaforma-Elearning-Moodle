...
/**
 * A bulk operation for the fsbac enrolment plugin to delete selected users enrolments.
 *
 * @package enrol_fsbac
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_fsbac_deleteselectedusers_operation extends enrol_bulk_enrolment_operation {
    ...
    public function get_title() {
        return get_string('deleteselectedusers', 'enrol_fsbac');
    }
     ...
     * @return enrol_fsbac_deleteselectedusers_form
     */
    public function get_form($defaultaction = null, $defaultcustomdata = null) {
        ...
        $defaultcustomdata['message'] = get_string('confirmbulkdeleteenrolment', 'enrol_fsbac');
        $defaultcustomdata['button'] = get_string('unenrolusers', 'enrol_fsbac');

        return new enrol_fsbac_deleteselectedusers_form($defaultaction, $defaultcustomdata);
    }
    ...
    public function process(course_enrolment_manager $manager, array $users, stdClass $properties) {
        if (!has_capability("enrol/fsbac:unenrol", $manager->get_context())) {
            return false;
        }
