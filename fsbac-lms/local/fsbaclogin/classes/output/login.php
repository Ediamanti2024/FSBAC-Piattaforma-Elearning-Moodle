...
class login implements renderable, templatable
{
    ...
    public function __construct(array $authsequence, $username = '')
    {
        ...
        $this->forgotpasswordurl = new moodle_url('/local/fsbaclogin/forgot_password.php');
        $this->loginurl = new moodle_url('/local/fsbaclogin/index.php');
        $this->signupurl = new moodle_url('/local/fsbaclogin/signup_with_cf.php');
        ...
        if (is_enabled_auth('none')) {
            ...
            $this->instructions = get_string('loginsteps', 'core', 'signup_with_cf.php');
        }
    ...
    public function export_for_template(renderer_base $output)
    {
        ...
        list($data->instructions, $data->instructionsformat) = \core_external\util::format_text(
            $this->instructions,
            FORMAT_MOODLE,
        ...
        $data->logourl = $OUTPUT->get_logo_url("150", "150");
