...
$baseurl = "/local/fsbaclogin/completed_dicolab_course.php";
...
$completed_dicolab_course = new \local_fsbaclogin\output\completed_dicolab_course($courseid);
$renderer = $PAGE->get_renderer('local_fsbaclogin');
echo $renderer->render($completed_dicolab_course);
