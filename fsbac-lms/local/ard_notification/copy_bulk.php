...
require_once __DIR__ . '/classes/form/copy_bulk_form.php';
...
$PAGE->set_title(get_string('copybulk', 'local_ard_notification'));
$PAGE->set_url(new moodle_url('/local/ard_notification/copy_bulk.php'), array('id' => $bulkid));
...
// Form instance
$mform = new copy_bulk_form(null, array());
...
// Form submitted and confirm
    ...
    // Copy bulk
    $mform->copy_bulk($formdata);
    // Redirect
    redirect(
        $bulk_monitoring,
        get_string('bulkcopied', 'local_ard_notification'),
        null,
