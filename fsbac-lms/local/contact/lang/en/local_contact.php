...
$string['bisognodiassistenza'] = "Bisogno di assistenza?";
$string['bisognodiassistenzadesc'] = "Non temere, siamo qui per aiutarti al meglio. Scegli tra le opzioni presenti per richiedere assistenza o per rispondere a dubbi e domande in relazione alla piattaforma.";
$string['scaricaguidarapida'] = "Scarica la guida rapida";
$string['scaricaguidarapidadesc'] = "Scarica la guida rapida descrizione";
$string['scaricaguida'] = "Scarica la guida";
$string['domandefrequenti'] = "Domande frequenti";
$string['domandefrequentidesc'] = "Abbiamo raccolto le domande più frequenti con le relative risposte per fornirti assistenza sempre disponibile h24";
$string['vaiadomandefrequenti'] = "Vai alle domande frequenti";
$string['domanda1'] = "Domanda1";
$string['domanda2'] = "Domanda2";
$string['domanda3'] = "Domanda3";
$string['risposta1'] = "Risposta1";
$string['risposta2'] = "Risposta2";
$string['risposta3'] = "Risposta3";
$string['scriviciunmessaggio'] = "Scrivici un messaggio";
$string['scriviciunmessaggiodesc'] = "Negli orari d'ufficio 09.00 / 17.00 dal lunedì al venerdì è possibile parlare con un nostro specialista helpdesk in chat per qualsiasi domanda.";
$string['richiestadiassistenza'] = "Richiesta di assistenza";
