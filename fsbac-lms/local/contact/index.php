...
if ($contact->sendmessage($email, $name)) {
    ...
    echo '<h3 style="text-align: center; padding: 10px;">' . get_string('eventmessagesent', 'message') . '</h3>';
    echo '<h5 style="text-align: center;  padding: 10px;">' .get_string('confirmationmessage', 'local_contact'). '</h5>';
} else {
