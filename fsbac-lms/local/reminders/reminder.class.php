...
abstract class local_reminder {
    ...
    protected $overduestyle = 'padding:10px 0 10px 10px;'.
        'background-color: rgba(126,101,160,.1);'.
        'margin:0;'.
        'font-family:Arial,Sans-serif;'.
        'font-size:16px;'.
        'font-weight:bold;'.
     ...
     * @var string
     */
    protected $footerstyle = 'background-color: rgba(126,101,160,.1);'.
        'color:#888;'.
     ...
     * @var string
     */
    protected $footerdefstyle = 'background-color:rgba(126,101,160,.1);'.
        'color:#888;'.
        'border-top:1px solid #ccc;'.
        'font-family:Arial,Sans-serif;'.
        'font-size:11px;'.
    ...
    protected function generate_event_link() {
		...
		$calurl = new moodle_url($CFG->wwwroot);
