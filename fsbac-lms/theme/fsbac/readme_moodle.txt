...
* remove folder theme/fsbac/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/fsbac/scss/bootstrap
...
* comment out this line in theme/fsbac/scss/_print.scss
    @page {
...
* remove folder theme/fsbac/amd/src/bootstrap
* copy the js files from ~/bootstrap/js/src to theme/fsbac/amd/src/bootstrap (including the subfolder)
* copy index.js from ~/bootstrap/js to theme/fsbac/amd/src
* edit theme/fsbac/amd/src/index.js and update import path (src -> bootstrap)
...
* in folder theme/fsbac run "grunt amd" to compile the bootstrap JS
* in folder theme/fsbac run "grunt css" to compile scss
