...
// The jQuery module is only used for interacting with Fsbacrap 4. It can we removed when MDL-71979 is integrated.
...
const disableButtonTooltip = (button, enableOnBlur) => {
    if (button.hasAttribute('data-original-title')) {
        // The jQuery is still used in Fsbacrap 4. It can we removed when MDL-71979 is integrated.
...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_fsbac/drawers:show}
     * @property {String} drawerShown See {@link event:theme_fsbac/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_fsbac/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_fsbac/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_fsbac/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_fsbac/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_fsbac/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_fsbac/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_fsbac/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_fsbac/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_fsbac/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_fsbac/drawers:hidden',
    };
     ...
     * @returns {module:theme_fsbac/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_fsbac/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_fsbac/drawers:close');
     ...
     *
     * @param {module:theme_fsbac/drawers} comparisonInstance
     */
