...
/**
 * Creates a navbar for fsbac that allows easy control of the navbar items.
 *
 * @package    theme_fsbac
 * @copyright  2021 Adrian Greeve <adrian@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class fsbacnavbar implements \renderable {
    ...
    public function __construct(\moodle_page $page) {
        ...
        $this->prepare_nodes_for_fsbac();
    }

    /**
     * Prepares the navigation nodes for use with fsbac.
     */
    protected function prepare_nodes_for_fsbac(): void {
        global $PAGE;
    ...
    /**
     * Get all the fsbacnavbaritem elements.
     *
     * @return fsbacnavbaritem[] Fsbac navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this fsbac navbar
     */
    ...
    /**
     * Remove a fsbacnavbaritem from the fsbac navbar.
     *
     * @param  string|int $itemkey An identifier for the fsbacnavbaritem
     * @param  int|null $itemtype An additional type identifier for the fsbacnavbaritem (optional)
     */
    ...
    /**
     * Removes the action from the last item of the fsbacnavbaritem.
     */
