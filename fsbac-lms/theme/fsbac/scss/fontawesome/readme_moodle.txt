...
2. SCSS:
  a. Replace the files in this folder (/theme/fsbac/scss/fontawesome) with the files in the scss folder.
  b. Copy the LICENSE.txt file from the root to theme/fsbac/scss/fontawesome.
  c. Update theme/fsbac/thirdpartylibs.xml.
