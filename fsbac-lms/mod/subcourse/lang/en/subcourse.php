 ...
 */
 ...
 $string['addmissingmetalink'] = 'Add missing metalink: [From course {$a->fromcourseid}, to course {$a->tocourseid}}]';
 ...
 $string['deleteorphanedmetalink'] = 'Delete orphaned metalink: [From course {$a->fromcourseid}, to course {$a->tocourseid}}]';
 ...
 * Percentual values - the final grade received in the referenced course is recalculated so that the percentage displayed in the referenced course matches the percentage displayed in this subcourse activity. If there are some excluded grades in the referenced course, the actual real grade value may not match.';
 ...
 $string['invaliduserlang'] = 'Invalid parameter userlang';
 ...
 $string['taskaddmissingmetalinks'] = 'Add Missing Metalinks';
 $string['taskcheckcompletedrefcourses'] = 'Check referenced courses completion';
 $string['taskdeleteorphanedmetalinks'] = 'Delete Orphaned Metalinks';
 $string['taskfetchgrades'] = 'Fetch subcourse grades';
 $string['taskupdatesubcoursenames'] = 'Update Subcourse Names';
 ...
 $string['updatesubcoursename'] = 'Update Subcourse module [Module ID: {$a->id}, Module Name: {$a->name} -> {$a->coursename}]';
