...
$string['modulename'] = 'Video Vimeo';
$string['pluginname'] = 'Video Vimeo';
$string['modulenameplural'] = 'Video Vimeo';
...
$string['videourl_help'] = '' .
    ...
    '<h4>Vimeo</h4>' .
    '<p>Inserisci il link di un video Vimeo:</p>' .
...
$string['seu_mapa_view'] = 'Hai visto il:';
$string['seu_mapa_ir_para'] = 'Go to {$a}';

$string['report'] = 'Vedi il report';
...
$string['completiondetail:completionpercent'] = 'Devi visualizzare almeno il {$a}% del video';
