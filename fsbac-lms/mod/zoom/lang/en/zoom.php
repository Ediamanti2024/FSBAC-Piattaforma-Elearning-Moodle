...
$string['zoom_license'] = 'Zoom license';
$string['zoom_license_help'] = 'Choosing one of these emails, the Zoom meeting will be created using the license associated to the chosen email instead of using the license of the user creating the meeting';
...
$string['zoomlicensealreadyset'] = '<p><b>A zoom license was already set. You can\'t change this setting after creating the zoom module.</b></p>';
