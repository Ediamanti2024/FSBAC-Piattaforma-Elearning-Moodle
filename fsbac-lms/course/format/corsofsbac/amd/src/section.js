...
/**
 * Format corsofsbac section extra logic component.
 *
 * @module     format_corsofsbac/section
...
class HighlightSection extends BaseComponent {
    ...
    create() {
        ...
        this.name = 'format_corsofsbac_section';
        ...
        // The corsofsbac format section specific actions.
        this.formatActions = {
