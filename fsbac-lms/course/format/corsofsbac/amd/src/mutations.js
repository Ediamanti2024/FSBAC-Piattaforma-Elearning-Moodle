 ...
 *
 * @module     format_corsofsbac/mutations
...
class CorsofsbacMutations extends DefaultMutations {
...
export const init = () => {
    ...
    courseEditor.addMutations(new CorsofsbacMutations());
