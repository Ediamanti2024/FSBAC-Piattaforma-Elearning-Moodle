@format @format_corsofsbac
Feature: Sections can be edited and deleted in corsofsbac format
  In order to rearrange my course contents
  As a teacher
  I need to edit and Delete corsofsbac
  ...
  Scenario: View the default name of the general section in corsofsbac format
    When I edit the section "0"
    Then the field "Custom" matches value "0"
    And the field "New value for Section name" matches value "General"

  Scenario: Edit the default name of the general section in corsofsbac format
  ...
  Scenario: View the default name of the second section in corsofsbac format
    When I edit the section "2"
    Then the field "Custom" matches value "0"
    And the field "New value for Section name" matches value "Topic 2"

  Scenario: Edit section summary in corsofsbac format
    When I edit the section "2" and I fill the form with:
      | Summary | Welcome to section 2 |
    Then I should see "Welcome to section 2" in the "Topic 2" "section"

  Scenario: Edit section default name in corsofsbac format
    When I edit the section "2" and I fill the form with:
      | Custom | 1                      |
  ...
  @javascript
  Scenario: Inline edit section name in corsofsbac format
  ...
  Scenario: Deleting the last section in corsofsbac format
  ...
  Scenario: Deleting the middle section in corsofsbac format
  ...
  @javascript
  Scenario: Adding sections at the end of a corsofsbac format
  ...
  @javascript
  Scenario: Adding sections between corsofsbac in corsofsbac format
