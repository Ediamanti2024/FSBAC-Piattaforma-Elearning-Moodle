@format @format_percorsofsbac
Feature: Sections can be edited and deleted in percorsofsbac format
  In order to rearrange my course contents
  As a teacher
  I need to edit and Delete percorsofsbac
  ...
  Scenario: View the default name of the general section in percorsofsbac format
    When I edit the section "0"
    Then the field "Custom" matches value "0"
    And the field "New value for Section name" matches value "General"

  Scenario: Edit the default name of the general section in percorsofsbac format
  ...
  Scenario: View the default name of the second section in percorsofsbac format
    When I edit the section "2"
    Then the field "Custom" matches value "0"
    And the field "New value for Section name" matches value "Topic 2"

  Scenario: Edit section summary in percorsofsbac format
    When I edit the section "2" and I fill the form with:
      | Summary | Welcome to section 2 |
    Then I should see "Welcome to section 2" in the "Topic 2" "section"

  Scenario: Edit section default name in percorsofsbac format
    When I edit the section "2" and I fill the form with:
      | Custom | 1                      |
  ...
  @javascript
  Scenario: Inline edit section name in percorsofsbac format
  ...
  Scenario: Deleting the last section in percorsofsbac format
  ...
  Scenario: Deleting the middle section in percorsofsbac format
  ...
  @javascript
  Scenario: Adding sections at the end of a percorsofsbac format
  ...
  @javascript
  Scenario: Adding sections between percorsofsbac in percorsofsbac format
