...
/**
 * Format percorsofsbac mutations.
 *
 ...
 *
 * @module     format_percorsofsbac/mutations
...
class PercorsofsbacMutations extends DefaultMutations {
...
export const init = () => {
    ...
    courseEditor.addMutations(new PercorsofsbacMutations());
