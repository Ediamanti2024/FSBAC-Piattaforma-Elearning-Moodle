...
/**
 * Format percorsofsbac section extra logic component.
 *
 * @module     format_percorsofsbac/section
...
class HighlightSection extends BaseComponent {
    ...
    create() {
        ...
        this.name = 'format_percorsofsbac_section';
        ...
        // The percorsofsbac format section specific actions.
        this.formatActions = {
