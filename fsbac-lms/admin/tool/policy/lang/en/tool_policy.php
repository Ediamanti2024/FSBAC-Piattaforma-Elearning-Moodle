...
$string['mustagreethisnecessarypolicy'] = 'Before continuing you need to acknowledge the policy {$a}';
$string['mustagreeatleastoneoptionalpolicy'] = 'Before continuing you need to acknowledge al least one policy among {$a}';
